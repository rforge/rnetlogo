NLDoCommandWhile <-
function(condition, ..., maxMinutes=10, nl.obj=NULL)
{
  if (is.null(nl.obj))
  ...
  .jcall(nl.obj, "V", "doCommandWhile", .jnew("java/lang/String", command), .jnew("java/lang/String", condition), .jnew("java/lang/Integer", as.integer(maxMinutes)))  
  # java error handling
  if (!is.null(e<-.jgetEx()))
  {
